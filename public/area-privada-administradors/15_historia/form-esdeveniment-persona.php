...
if ($segments[2] === "modifica-esdeveniment-persona") {
    $slug = $routeParams[0];
...
<div class="container-fluid form">
    ...
    if ($modificaBtn === 1) {
    ?>
        <h2>Vinculació d'un esdeveniment històric amb una persona</h2>
        <h4 id="bookUpdateTitle"></h4>
    <?php
    } else {
    ?>
        <h2>Modificació del vincle entre un esdeveniment històric amb una persona</h2>
    <?php
    }
    ?>
    ...
    <form method="POST" action="" id="formEsdeveniment" class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <select class="form-select" name="idEsdev" id="idEsdev" value="">
            </select>
        </div>
...
<script>
    function formUpdateLlibre(slug) {
        ...
        fetch(urlAjax, {
            ...
            .then(data => {
                ...
                selectOmplirDades("/api/historia/get/?llistatEsdevenimentsSelect", data.id, "idEsdev", "esdeNom");
                selectOmplirDades("/api/historia/get/?llistatPersones", "", "idPersona", "nom");
    ...
    function formUpdateLlibre2(id) {
        let urlAjax = "/api/historia/get/?formEsdevenimentsPersona=" + id;
        ...
        fetch(urlAjax, {
            ...
            .then(data => {
                ...
                // Llenar selects con opciones
                selectOmplirDades("/api/historia/get/?llistatEsdevenimentsSelect", data.idEsdev, "idEsdev", "esdeNom");
