...
<div class="barraNavegacioContenidor">
    <h6><a href="">Intranet</a> > <a href="<?php echo $url['historia']; ?>">Base de dades Història</a> > <a href="<?php echo $url['historia']; ?>/llistat-organitzacions">Llistat d'organitzacions</a> </h6>
</div>

<h1>Base de dades d'Història: llistat d'organitzacions</h1>

<button onclick="window.location.href='<?php echo $url['historia']; ?>/nova-organitzacio/'" class="button btn-gran btn-secondari">Afegir organització</button>
