...
<div class="container form">
  ...
  <form method="POST" class="row g-3" id="formPersona"
    ...
    <!-- COGNOMS -->
    <div class="col-md-4">
      <label for="cognoms" class="form-label fw-medium">Cognoms</label>
    ...
    <!-- SEXE -->
    <div class="col-md-4">
      <label for="sexe_id" class="form-label fw-medium">Gènere</label>
      <select class="form-select" name="sexe_id" id="sexe_id"></select>
    </div>

    <!-- WEB -->
    <div class="col-md-4">
      <label for="web" class="form-label fw-medium">Pàgina web</label>
    ...
    <!-- NAIXEMENT -->
    <div class="col-md-4">
      <label for="dia_naixement" class="form-label fw-medium">Dia naixement</label>
      <select class="form-select" name="dia_naixement" id="dia_naixement"></select>
    </div>

    <div class="col-md-4">
      <label for="mes_naixement" class="form-label fw-medium">Mes naixement</label>
      <select class="form-select" name="mes_naixement" id="mes_naixement"></select>
    </div>

    <div class="col-md-4">
      <label for="any_naixement" class="form-label fw-medium">Any naixement</label>
      <input class="form-control" type="text" name="any_naixement" id="any_naixement">
    </div>

    <!-- DEFUNCIÓ -->
    <div class="col-md-4">
      <label for="dia_defuncio" class="form-label fw-medium">Dia defunció</label>
      <select class="form-select" name="dia_defuncio" id="dia_defuncio"></select>
    </div>

    <div class="col-md-4">
      <label for="mes_defuncio" class="form-label fw-medium">Mes defunció</label>
      <select class="form-select" name="mes_defuncio" id="mes_defuncio"></select>
    </div>

    <div class="col-md-4">
      <label for="any_defuncio" class="form-label fw-medium">Any defunció</label>
      <input class="form-control" type="text" name="any_defuncio" id="any_defuncio">
    </div>

    <!-- CIUTATS -->
    <div class="col-md-4">
      <label for="ciutat_naixement_id" class="form-label fw-medium">Ciutat naixement</label>
      <select class="form-select" name="ciutat_naixement_id" id="ciutat_naixement_id"></select>
    </div>

    <div class="col-md-4">
      <label for="ciutat_defuncio_id" class="form-label fw-medium">Ciutat defunció</label>
      <select class="form-select" name="ciutat_defuncio_id" id="ciutat_defuncio_id"></select>
    </div>

    <!-- PAÍS -->
    <div class="col-md-4">
      <label for="pais_autor_id" class="form-label fw-medium">País</label>
    ...
    <!-- IMATGE -->
    <div class="col-md-4">
      <label for="img_id" class="form-label fw-medium">Imatge existent</label>
      <select class="form-select" name="img_id" id="img_id"></select>
    </div>

    <div class="col-md-4">
      <label for="img_upload" class="form-label fw-medium">Pujar nova imatge</label>
      <input class="form-control" type="file" name="img_upload" id="img_upload" accept="image/*">
    </div>

    <div class="col-md-4">
      <label for="alt" class="form-label fw-medium">Nom imatge</label>
