...
$routes = [
    ...
    APP_GESTIO . $url['agenda'] => [
        'view' => APP_INTRANET_DIR . APP_AGENDA_DIR . 'index.php',
        'needs_session' => true,
        'header_footer' => false,
        'header_menu_footer' => false,
        'apiSenseHTML' => false,
    ...
    APP_GESTIO . $url['agenda'] . "/llistat-esdeveniments" => [
        'view' => APP_INTRANET_DIR . APP_AGENDA_DIR . 'llistat-esdeveniments.php',
        'needs_session' => true,
        'header_footer' => false,
        'header_menu_footer' => false,
        'apiSenseHTML' => false,
    ...
    APP_GESTIO . $url['agenda'] . "/calendari-esdeveniments" => [
        'view' => APP_INTRANET_DIR . APP_AGENDA_DIR . 'calendari-esdeveniments.php',
        'needs_session' => true,
        'header_footer' => false,
        'header_menu_footer' => false,
        'apiSenseHTML' => false,
