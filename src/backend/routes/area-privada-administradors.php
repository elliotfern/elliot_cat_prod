...
$routes = [
    ...
    APP_GESTIO . $url['comptabilitat'] . '/llistat-productes' => route(APP_INTRANET_DIR . APP_COMPTABILITAT_DIR . 'llistat-productes.php'),
    APP_GESTIO . $url['comptabilitat'] . '/nou-producte' => route(APP_INTRANET_DIR . APP_COMPTABILITAT_DIR . 'form-producte.php'),
    APP_GESTIO . $url['comptabilitat'] . '/modifica-producte/{id}' => route(APP_INTRANET_DIR . APP_COMPTABILITAT_DIR . 'form-producte.php'),
    ...
    APP_GESTIO . $url['viatges'] . '/llistat-espais' => route(APP_INTRANET_DIR . APP_VIATGES_DIR . 'llistat-espais.php'),
    APP_GESTIO . $url['viatges'] . '/llistat-espais-visitats' => route(APP_INTRANET_DIR . APP_VIATGES_DIR . 'llistat-espais-visitats.php'),
    ...
    APP_GESTIO . $url['viatges'] . '/modifica-espai-visitat/{slug}' => route(APP_INTRANET_DIR . APP_VIATGES_DIR . 'form-espai-visitat.php'),
    APP_GESTIO . $url['viatges'] . '/nou-espai-visitat' => route(APP_INTRANET_DIR . APP_VIATGES_DIR . 'form-espai-visitat.php'),
