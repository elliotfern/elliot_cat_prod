...
class Tables
{
    ...
    public const LLIBRES_GRUP_LLIBRES = 'db_llibres_grup_llibres';
    public const LLIBRES_ETIQUETES = 'db_llibres_etiquetes';
    public const LLIBRES_ETIQUETES_LLIBRES = 'db_llibres_etiquetes_llibres';
